...
pull-request-triggered check names: `build`, `check`, `commits`, `format`,
`lint-nix`, `secrets` Names came from an actual pull request, not guessed
from workflow job keys.
